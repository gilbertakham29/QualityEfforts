<template>
    <div class="bg-[#000837] max-w-screen py-5">
        ...
        <section class="col-span-4">
            <div class="flex flex-col justify-center">
                ...
                <h4 class="text-xl font-bold md:text-5xl text-center text-[#299646] ">
                    Robotics & Automation
                </h4>
            </div>
        </section>
    ...
    <div class="flex md:flex-row flex-col w-11/12 mx-auto items-center mt-5 py-5 gap-5">
        <div class="md:flex-col text-center">
            <img class="w-76 border border-[#000837] rounded-full" src="https://save-effort.netlify.app/_nuxt/reviewer.72ce0405.svg"/>
